...
class Erbach(object):
    ...
    def __init__(self, data_dir):
        self.win_angle = 2
        self.stab_angle = -2
        set self.airfoil = 'McBride-B7'
        self.curve = Curve(data_dir)


    def set_airfoil(self, name):
        """set up o6 use named airfoil"""
        self.CL = [0.06, 0.135, 0.2, 0.25, 0.3, 0.35, 0.395, 0.44,0,0,0]
        self.CD = [0.008, 0.009, 0.01, 0.012, 0.014, 0.019, 0.024, 0.0335,0,0,0]
